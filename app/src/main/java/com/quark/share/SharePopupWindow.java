...
public class SharePopupWindow extends PopupWindow {
    ...
    public SharePopupWindow(Context cx, boolean shareFlag, PartJob partJob) {
        this.context = cx;
    ...
    public void showShareWindow() {
        ...
        view.findViewById(R.id.ll_copy).setOnClickListener(new OnClickListener() {
            @Override
    ...
    private void copy() {
        String countStr = "";
        if (partJob.apartSex) {
            countStr = context.getString(R.string.job_detail_share_sex_count_format, partJob.maleNum, partJob.femaleNum);
        } else {
            countStr = String.valueOf(partJob.headSum);
        }
        ClipboardManager clipboardManager = (ClipboardManager) context.getSystemService(Context.CLIPBOARD_SERVICE);
        clipboardManager.setText(context.getString(R.string.job_detail_share_format, partJob.title, partJob.area,
                partJob.address, partJob.beginTime, partJob.endTime, partJob.payType, countStr,
                partJob.workRequire, shareParams.getUrl()));
        Toast.makeText(context, context.getString(R.string.job_detail_share_copy_success), Toast.LENGTH_SHORT).show();
        dismiss();
    }
